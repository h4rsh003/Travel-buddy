    ...
    return (
        <>
            ...
            <ConfirmationModal
                ...
                onConfirm={onDelete}
                title="Delete Trip"
                message={`Are you sure you want to delete your trip to ${typeof trip.destination === 'string' ? trip.destination : trip.destination?.name}? This action cannot be undone.`}
