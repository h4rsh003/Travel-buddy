...
export default function ChatWindow() {
    ...
    }, [activeConversationId, addMessage, myUserId, updateMessageStatus, setMessagesDeleted, bumpConversationToTop]);
                            ...
                            if (msg.isSystemMessage) {
                                return (
                                    <div key={msg.id} className="flex justify-center my-2">
                                        <div className="bg-travel-card/60 border border-travel-border px-3 py-1 rounded-full text-[10px] sm:text-xs text-travel-text-muted font-medium shadow-sm">
                                            {msg.content}
                                        </div>
                                    </div>
                                );
