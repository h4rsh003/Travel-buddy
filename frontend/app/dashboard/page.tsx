                                ...
                                <div key={trip.id} className="bg-travel-card rounded-xl shadow-sm border border-travel-border overflow-hidden transition hover:shadow-md">
                                    ...
                                    <div className="flex flex-col md:flex-row">
                                        ...
                                        <div className="flex-1 p-6 flex flex-col justify-center border-r-0 md:border-r border-travel-border">
                                            <div className="flex flex-col gap-1 mb-4">
                                                <div className="flex items-center gap-3">
                                                    <h3 className="text-2xl font-bold text-travel-text">{trip.destination.name}</h3>
                                        ...
                                        <button
                                            ...
                                            className={`w-full md:w-64 border-t md:border-t-0 p-6 flex md:flex-col items-center justify-between md:justify-center gap-3 hover:bg-travel-bg/50 transition cursor-pointer text-left md:text-center group ${isExpanded ? "bg-travel-bg/50" : ""
                                                }`}
                                        >
                                                        ...
                                                        <div key={req.id} className="flex justify-between items-center bg-travel-card p-4 rounded-xl border border-travel-border shadow-sm">
                                                            <div className="flex items-center gap-3 min-w-0">
                                                                ...
                                                                <div className="min-w-0">
                                                                    ...
                                                                    {req.status !== 'pending' ? (
                                                                        <span className={`text-[10px] uppercase font-bold ${req.status === 'accepted' ? 'text-green-600' : 'text-red-500'
                                                                            }`}>
                                                                            {req.status}
                                                                        </span>
                                                                    ) : (
