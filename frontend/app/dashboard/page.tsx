...
import { FiCalendar, FiTrash2, FiUsers, FiMapPin, FiActivity, FiChevronDown, FiChevronUp } from "react-icons/fi";
                                                            ...
                                                            <div key={req.id} className="flex justify-between items-center bg-travel-card p-3 rounded-lg border border-travel-border shadow-sm">
                                                                <div className="flex items-center gap-3">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        {req.status !== 'pending' && (
                                                                            <p className={`text-[10px] uppercase font-bold ${req.status === 'accepted' ? 'text-green-600' : 'text-red-500'
                                                                                }`}>
                                                                                {req.status}
                                                                            </p>
                                                                        )}
