                    ...
                    <div className="flex mt-4 sm:mt-0 gap-3">
                        <button 
                            ...
                            className={`px-4 py-2 rounded-lg font-medium text-sm transition ${
                                isEditing 
                                ? "bg-travel-bg text-travel-text hover:bg-gray-200 border border-travel-border" 
                ...
                {isEditing ? (
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 animate-fade-in">
                         <div>
                            ...
                            <input {...register("name")} type="text" className="w-full rounded-lg border border-travel-border p-3 text-travel-text bg-white focus:ring-2 focus:ring-travel-accent focus:outline-none transition" />
                         </div>
                         <div>
                            <label className="block text-sm font-semibold text-travel-text mb-1">Bio</label>
                            <textarea {...register("bio")} rows={3} className="w-full rounded-lg border border-travel-border p-3 text-travel-text bg-white focus:ring-2 focus:ring-travel-accent focus:outline-none transition" />
                         </div>
                         <div>
                            <label className="block text-sm font-semibold text-travel-text mb-1">Location</label>
                            <input {...register("location")} type="text" className="w-full rounded-lg border border-travel-border p-3 text-travel-text bg-white focus:ring-2 focus:ring-travel-accent focus:outline-none transition" />
                         </div>
                         <div>
                            <label className="block text-sm font-semibold text-travel-text mb-1">Interests</label>
                            <input {...register("interests")} type="text" className="w-full rounded-lg border border-travel-border p-3 text-travel-text bg-white focus:ring-2 focus:ring-travel-accent focus:outline-none transition" />
